...
module.exports.run = (client,message)=>{
    const eb = new RichEmbed()
        ...
        .setColor(0x49C4EF)
		.setDescription('KrunkerLFG is a LFG bot designed for the online FPS game, krunker.io.')
		.addField('Version:', `**${config.version}**`, true)
		.addField('Creator:', '**JJ_G4M3R & Jytesh**', true)
		.addField('Invite:', '[https://krunker.io/lfgbot.html](https://discordapp.com/api/oauth2/authorize?client_id=678674368783450119&permissions=387136&scope=bot)')
